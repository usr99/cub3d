...
/*   Updated: 2021/01/06 17:25:52 by mamartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		copy_buf(char **tmp, char *buf);
int		search_newline(char **line, char *buf, char **tmp);
int		check_tmp(char *tmp, char **line);
int		copy_line(char **line, char **tmp);
